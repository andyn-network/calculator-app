...
function App() {
  // state variables to manage the answer and expression in the calculator
  const [answer, setAnswer] = useState("");
  const [expression, setExpression] = useState("");
  const et = expression.trim(); // trimmed version of the expression

  // function to check if a symbol is an arithmic operator
